...
public class ProcessController {
    ...
    @PostMapping("/process")
    public ResponseEntity<String> create(@RequestBody ProcessDto dto) {
    ...
    public ResponseEntity<String> update(@PathVariable("number") String processNumber, @RequestBody ProcessDto dto) {
